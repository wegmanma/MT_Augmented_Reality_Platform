...
public:
    ...
    void create(VkDevice device, VkPhysicalDevice physicalDevice, VkRenderPass renderPass, VkCommandPool commandPool, VkQueue graphicsQueue, VkExtent2D swapChainExtent, size_t numSwapChainImages, VkImageView combinedImageView, VkSampler combinedSampler);

    void recreate(VkDevice device, VkPhysicalDevice physicalDevice, VkRenderPass renderPass, VkExtent2D swapChainExtent, size_t numSwapChainImages, VkImageView combinedImageView, VkSampler combinedSampler);
    ...
    void createDescriptorSets(VkDevice device, size_t numSwapChainImages, VkImageView combinedImageView, VkSampler combinedSampler);
